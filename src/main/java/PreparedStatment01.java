...
/*
PreparedStatment Statment extend eder.(Statment'in daha gelismis halidir.)

PreparedStatment, birden fazla kez kullanilabilen onceden derlenmis parametreli sorgular
olusturmamizi saglar.
 */
public class PreparedStatment01 {
  ...
  //      st.executeUpdate(query);
        ...
        //String tipindeki sorgudan parametreli bir sorgu olustur
        ...
        prst2.setString(1,"matematik");//DELETE FROM ogrenciler WHERE bolum ILIKE ?
        int deleted=prst2.executeUpdate();
        System.out.println("deleted = " + deleted);

        //ORNEK4: Prepared Statment kullanarak bolumler tablosuna
        //Yazilim Muhendisligi(id=5006,taban_puan=475,kampus='Merkez') bolumunu ekleyiniz.

        String query4="INSERT INTO bolumler VALUES(?,?,?,?)";

        PreparedStatement prst3=connection.prepareStatement(query4);
        prst3.setInt(1,5006);
        prst3.setString(2,"Yazilim Muhendisligi");
        prst3.setInt(3,475);
